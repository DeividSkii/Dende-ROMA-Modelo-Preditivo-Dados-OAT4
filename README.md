...
O atributo winner do dataset é utilizado como variável alvo (target) para treinamento do modelo.

# 🎯 Objetivo

Desenvolver um modelo de Machine Learning para:

- Analisar os dados históricos do dataset FIFA World Cup 2026;
- Identificar padrões relevantes;
- Treinar modelos preditivos;
- Classificar seleções com base na probabilidade de vitória;
